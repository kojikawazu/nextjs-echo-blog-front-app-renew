      ...
      <div className="max-w-7xl mx-auto px-8 py-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="flex items-center space-x-8">
            <Link href="/" className="text-gray-600 hover:text-sky-500 transition-colors">記事一覧</Link>
            {user ? (
              <>
                <Link href="/new" className="text-gray-600 hover:text-sky-500 transition-colors">新規投稿</Link>
