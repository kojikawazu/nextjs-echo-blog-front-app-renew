export const COMMON_CONSTANTS = {
    URL: {
        ...
        BLOG_UPDATE_BY_ID: '/api/blogs/:id',
        BLOG_DELETE_BY_ID: '/api/blogs/:id',

        BLOG_LIKE_GENERATE_VISIT_ID: '/api/blog-likes/generate-visit-id',
        BLOG_LIKE_FETCH_LIKED_BLOGS: '/api/blog-likes',
        BLOG_LIKE_CREATE: '/api/blog-likes/:blogId',
        BLOG_LIKE_DELETE: '/api/blog-likes/:blogId',
        BLOG_LIKE_IS_LIKED: '/api/blog-likes/is-liked/:blogId',

        COMMENTS_BLOG: '/api/comments/:blogId',
