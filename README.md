...
2. Docker イメージビルド
3. Google Cloud Run へデプロイ

デプロイの詳細は [docs/09-architecture-specification.md](./docs/09-architecture-specification.md) を参照。

## Architecture

![Architecture](./architecture/architecture.drawio.png)

詳細なアーキテクチャ（Provider 構成・データフロー・デプロイフロー等）は [docs/09-architecture-specification.md](./docs/09-architecture-specification.md) を参照。
